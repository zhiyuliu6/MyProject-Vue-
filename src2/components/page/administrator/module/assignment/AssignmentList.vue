                        ...
                        <el-card class="list box-card" v-for="(task,index) in filterTask" :key="task.id" ref="task">
                                <el-collapse v-model="activeName" accordion>
                                        <el-collapse-item class="collapse" :title="task.taskList.staffLeader.bigName+'------------->'+task.taskList.staffLeader.smallName" :name="index">
                                                ...
                                                <el-button @click="toShow(task.taskList.picUil)" v-if="task.taskList.finished===1" style="margin-top: 10px;margin-left: -20px" class="el-icon-download" type="primary">View the result</el-button>
                                                <el-image-viewer
                                                        v-if="showViewer"
